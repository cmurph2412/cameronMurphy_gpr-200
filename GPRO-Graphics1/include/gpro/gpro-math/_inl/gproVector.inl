...
/*
	...
	Modified because: Add remaining operators for vec3
*/
...
//Multiplication operator for two vec3s
inline vec3 operator*(const vec3& u, const vec3& v)
{
	return vec3(u.x * v.x, u.y * v.y, u.z * v.z);
}

//Multiplication operators for vec3 and float
...
//Vec3 unit_vector function
inline vec3 unit_vector(vec3 v)
{
	return v / v.length();
}

//Determines length of vec3
inline float vec3::length() const
{
	return sqrt(length_squared());
}

//Determines length squared of vec3
