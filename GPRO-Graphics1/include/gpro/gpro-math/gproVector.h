...
/*
	...
	Modified because: To add in more operators into the vec3 union
*/
...
union vec3
{
	...
	vec3 operator-() const { return vec3(-x, -y, -z); }      //subtraction operator

	float length() const;     //length function definition

	float length_squared() const;      //length squared function definition
